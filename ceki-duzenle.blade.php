        ...
        <div class="container-fluid">
            ...
            <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    ...
                                    @php
                                                  ...
                                                  $id  = $_GET['id'];
                                                    $ceki = \App\Models\CekiModel::where('id', $_GET['id'])->first();
                                                    $cari = \App\Models\CariModel::where('id', $ceki->musteri)->first();
            ...
            <div class="col-12">
                    <div class="card m-b-30">
                        ...
                        <hr style="border:blue 1px solid"></hr>
                                                <form action="{{ route('cekikaydet') }}" id="siparis-kaydet-form" method="post" >
                                                @csrf
                                                    <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                            <select  class="js-example-basic-single form-control" style="height:80px" id="firma" name="firma">
                                                                <option value="{{$cari->id}}">{{$cari->firma_adi}}</option>
                                                            ...
                                                            <input type="text" name="duzenle" value="1" style="display:none" id="">
                                                            <input type="text" name="id" value="{{$id}}" style="display:none" id="">
                                                            
                                                              <br></br>
                                                            <input type="text" name="aciklama" clas="form-control" value="{{$ceki->aciklama}}" style="width:400px;height:40px;" >
                                                            </div>
                                                       </div>
...
<div class="row">
            <div class="col-12">
                    <div class="card m-b-30">
                        ...
                        <div class="col-md-4">  <h3>Ceki Kumaşlar</h3></div>
                        <div class="col-md-4"></div>
                        <div class="col-md-4"><button style="float:right" type="submit" class="btn btn-success waves-effect waves-light">Çekiyi Kaydet</button></div>
                        </div>
                        </form>
                        <hr style="border:blue 1px solid"></hr>
                        ...
                        <table  class="table table-striped mb-0 table-editable">
                                ...
                                @foreach(\App\Models\CekiUrunModel::where('ceki_id', $id)->orderBy('id', 'DESC')->get() as $val)
                                @php
                                $kumas = \App\Models\KumasModel::where('id', $val->kumas_id)->first();
                                @endphp
                                <tr>
                                <td>{{$val->barkod}}</td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_kalite" class="form-control duzenle3" value="{{$val->kalite}}"></td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_parti" class="form-control duzenle3" value="{{$val->parti_no}}"></td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_metre" class="form-control duzenle3" value="{{$val->metre}}"></td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_kumas_tipi" class="form-control duzenle3" value="{{$kumas->kumas_tipi}}"></td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_lot_no"  class="form-control duzenle3" value="{{$val->lot}}"></td>
                                <td> <input name="" data-id="{{$val->id}}" data-type="kumas_aciklama" class="form-control duzenle3" value="{{$val->aciklama}}"></td>
...
$.ajax({
   ...
   data:{id:islemid,typer:ceki_id,sil:"0"},
  ...
  url:'/ceki-urun-getir',
   ...
   data:{id:islemid,sil:"1",typer:ceki_id},
